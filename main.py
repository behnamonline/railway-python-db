...
if not os.path.exists(DB_DIR):
    raise RuntimeError(
        f"\n\n❌ ERROR: Volume path '{DB_DIR}' not found!\n"
        "برنامه متوقف شد. این پروژه فقط در صورت متصل بودن Volume کار می‌کند.\n"
    )
...
def index(msg: str = "", edit: int = None):
    ...
    # قالب کامل HTML با پدینگ مناسب در body (style="padding-bottom:90vh")
    html_content = f"""
    <!DOCTYPE html>
